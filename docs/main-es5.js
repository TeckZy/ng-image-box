...
/***/ "../../dist/ngx-image-box/fesm5/ngx-image-box.js":
/*!****************************************************************************************!*\
  !*** /Users/akashs/ng-image-box/NgxImageBox/dist/ngx-image-box/fesm5/ngx-image-box.js ***!
  \****************************************************************************************/
/*! exports provided: Image, LIGHTBOX_CONFIG, LightBoxEvents, NgxImageBoxModule, NgxImageboxComponent, NgxImageboxService, providers */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgxImageBoxModule", function() { return NgxImageBoxModule; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgxImageboxComponent", function() { return NgxImageboxComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgxImageboxService", function() { return NgxImageboxService; });
 ...
 */
var NgxImageboxService = /** @class */ (function () {
    function NgxImageboxService() {
     ...
     * @return {?}
     */
    NgxImageboxService.prototype.createGallery = /**
     * @param {?} key
     * @return {?}
     */
    function (key) {
     ...
     * @return {?}
     */
    NgxImageboxService.prototype._getReference = /**
     * @private
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    NgxImageboxService.prototype.setImages = /**
     * @param {?} key
     * @param {?} images
     * @return {?}
     */
     ...
     * @return {?}
     */
    NgxImageboxService.prototype.addImage = /**
     * @param {?} key
     * @param {?} image
     * @return {?}
     */
     ...
     * @return {?}
     */
    NgxImageboxService.prototype.getImages = /**
     * @param {?} key
     * @return {?}
     */
    function (key) {
     ...
     * @return {?}
     */
    NgxImageboxService.prototype.removeImage = /**
     * @param {?} key
     * @param {?} id
     * @return {?}
     */
     ...
     * @return {?}
     */
    NgxImageboxService.prototype.openGallery = /**
     * @param {?} index
     * @return {?}
     */
    function (index) {
     ...
     * @return {?}
     */
    NgxImageboxService.prototype.openAutoGallery = /**
     * @param {?} index
     * @param {?} interval
     * @return {?}
     */
     ...
     * @return {?}
     */
    NgxImageboxService.prototype.getReference = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    NgxImageboxService.prototype.clearReference = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    NgxImageboxService.prototype.ngOnDestroy = /**
     * @return {?}
     */
    function () {
        if (this.galleryElement) {
    ...
    NgxImageboxService.decorators = [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"] }
    ];
    return NgxImageboxService;
}());
if (false) {}
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
var PhotoswipeImage = /** @class */ (function () {
    function PhotoswipeImage(src, w, h) {
        this.src = src;
        this.w = w;
        this.h = h;
    }
    return PhotoswipeImage;
}());
if (false) {}
 ...
 */
/** @type {?} */
var LIGHTBOX_CONFIG = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('LIGHTBOX_CONFIG');
/** @type {?} */
var LightBoxEvents = [
    'beforeChange',
    'afterChange',
 ...
 */
/** @type {?} */
var IL = imagesloaded__WEBPACK_IMPORTED_MODULE_5__;
var NgxImageboxComponent = /** @class */ (function () {
    function NgxImageboxComponent(lbService, ref, platformId, defaults) {
        var _this = this;
        ...
        ref.detach();
        this.isBrowser = this.isBrowser = Object(_angular_common__WEBPACK_IMPORTED_MODULE_6__["isPlatformBrowser"])(platformId);
        ...
        function (index) {
            if (index === 'GET_REF') {
                _this.lbService.galleryElement = _this.gallery;
            }
            else
                _this.openImage(index);
        }));
     ...
     * @return {?}
     */
    NgxImageboxComponent.prototype.ngOnChanges = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    NgxImageboxComponent.prototype.openImage = /**
     * @param {?} index
     * @return {?}
     */
    function (index) {
        /** @type {?} */
        var galleryDOM = document.getElementsByClassName('ngx_photoswipe')[0];
     ...
     * @return {?}
     */
    NgxImageboxComponent.prototype.getImages = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    NgxImageboxComponent.prototype.checkImageLoad = /**
     * @private
     * @return {?}
     */
    function () {
         ...
         */
        function (check) {
            _this.imagesLoaded.emit(check.images.length);
        }));
    };
    /**
     * @private
     ...
     * @return {?}
     */
    NgxImageboxComponent.prototype.openPhotoSwipe = /**
     * @private
     * @param {?} index
     * @param {?} galleryDOM
     * @return {?}
     */
    function (index, galleryDOM) {
        /** @type {?} */
        var options = {};
        options.galleryUID = galleryDOM.getAttribute('data-pswp-uid') || 1;
        options.index = index ? index : 0;
        /** @type {?} */
        var PSWP = (/** @type {?} */ (document.querySelectorAll('.pswp')[0]));
        this.gallery = new photoswipe__WEBPACK_IMPORTED_MODULE_3__(PSWP, photoswipe_dist_photoswipe_ui_default__WEBPACK_IMPORTED_MODULE_4__, this.getImagesAsPhotoswipe(), this.getConfigOptions(options));
        this.gallery.init();
        this.listenForEvent();
        return false;
    };
     ...
     * @return {?}
     */
    NgxImageboxComponent.prototype.getConfigOptions = /**
     * @private
     * @param {?} defaultOptions
     * @return {?}
     */
    function (defaultOptions) {
        /** @type {?} */
        var config = Object(tslib__WEBPACK_IMPORTED_MODULE_2__["__assign"])({}, this.defaults);
     ...
     * @return {?}
     */
    NgxImageboxComponent.prototype.getImagesAsPhotoswipe = /**
     * @private
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    NgxImageboxComponent.prototype.ngOnDestroy = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    NgxImageboxComponent.prototype._destroy = /**
     * @private
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    NgxImageboxComponent.prototype.listenForEvent = /**
     * @return {?}
     */
    function () {
        var _this = this;
         ...
         */
        function (index, item) {
            _this.imageLoadComplete.emit({ index: index, item: item });
        }));
         ...
         */
        function (item) {
            _this.parseVerticalMargin.emit(item);
        }));
        this.gallery.listen('close', (/**
         * @return {?}
         */
        function () {
            _this.lbService.clearReference();
            _this.close.emit();
        }));
         ...
         */
        function (_offset) {
            _this.updateScrollOffset.emit(_offset);
        }));
        ...
        function (e, isDown, preventObj) {
            _this.preventDragEvent.emit({ e: e, isDown: isDown, preventObj: preventObj });
        }));
    ...
    NgxImageboxComponent.decorators = [
    ...
    /** @nocollapse */
    NgxImageboxComponent.ctorParameters = function () { return [
        { type: NgxImageboxService },
    ...
    NgxImageboxComponent.propDecorators = {
 ...
 */
/** @type {?} */
var providers = [NgxImageboxService];
var NgxImageBoxModule = /** @class */ (function () {
    function NgxImageBoxModule() {
    }
    /**
     * @return {?}
     */
    NgxImageBoxModule.forRoot = /**
     * @return {?}
     */
    function () {
        return {
...
//# sourceMappingURL=ngx-image-box.js.map


/***/ }),

/***/ "../../dist/ngx-image-box/ngx-image-box.ngfactory.js":
/*!********************************************************************************************!*\
  !*** /Users/akashs/ng-image-box/NgxImageBox/dist/ngx-image-box/ngx-image-box.ngfactory.js ***!
  \********************************************************************************************/
/*! exports provided: NgxImageBoxModuleNgFactory, RenderType_NgxImageboxComponent, View_NgxImageboxComponent_0, View_NgxImageboxComponent_Host_0, NgxImageboxComponentNgFactory */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgxImageBoxModuleNgFactory", function() { return NgxImageBoxModuleNgFactory; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderType_NgxImageboxComponent", function() { return RenderType_NgxImageboxComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_NgxImageboxComponent_0", function() { return View_NgxImageboxComponent_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_NgxImageboxComponent_Host_0", function() { return View_NgxImageboxComponent_Host_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgxImageboxComponentNgFactory", function() { return NgxImageboxComponentNgFactory; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var ngx_image_box__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ngx-image-box */ "../../dist/ngx-image-box/fesm5/ngx-image-box.js");
...
var NgxImageBoxModuleNgFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵcmf"](ngx_image_box__WEBPACK_IMPORTED_MODULE_1__["NgxImageBoxModule"], [], function (_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵmod"]([_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵmpd"](512, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ComponentFactoryResolver"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵCodegenComponentFactoryResolver"], [[8, []], [3, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ComponentFactoryResolver"]], _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModuleRef"]]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵmpd"](4608, _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgLocalization"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgLocaleLocalization"], [_angular_core__WEBPACK_IMPORTED_MODULE_0__["LOCALE_ID"], [2, _angular_common__WEBPACK_IMPORTED_MODULE_2__["ɵangular_packages_common_common_a"]]]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵmpd"](135680, ngx_image_box__WEBPACK_IMPORTED_MODULE_1__["NgxImageboxService"], ngx_image_box__WEBPACK_IMPORTED_MODULE_1__["NgxImageboxService"], []), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵmpd"](1073742336, _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], []), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵmpd"](1073742336, ngx_image_box__WEBPACK_IMPORTED_MODULE_1__["NgxImageBoxModule"], ngx_image_box__WEBPACK_IMPORTED_MODULE_1__["NgxImageBoxModule"], [])]); });

var styles_NgxImageboxComponent = [".pswp{display:none;position:absolute;width:100%;height:100%;left:0;top:0;overflow:hidden;touch-action:none;z-index:1500;-webkit-text-size-adjust:100%;-webkit-backface-visibility:hidden;outline:0}.pswp *{box-sizing:border-box}.pswp img{max-width:none}.pswp--animate_opacity{opacity:.001;will-change:opacity;-webkit-transition:opacity 333ms cubic-bezier(.4,0,.22,1);transition:opacity 333ms cubic-bezier(.4,0,.22,1)}.pswp--open{display:block}.pswp--zoom-allowed .pswp__img{cursor:-webkit-zoom-in;cursor:-moz-zoom-in;cursor:zoom-in}.pswp--zoomed-in .pswp__img{cursor:-webkit-grab;cursor:-moz-grab;cursor:grab}.pswp--dragging .pswp__img{cursor:-webkit-grabbing;cursor:-moz-grabbing;cursor:grabbing}.pswp__bg{position:absolute;left:0;top:0;width:100%;height:100%;background:#000;opacity:0;-webkit-transform:translateZ(0);transform:translateZ(0);-webkit-backface-visibility:hidden;will-change:opacity}.pswp__scroll-wrap{position:absolute;left:0;top:0;width:100%;height:100%;overflow:hidden}.pswp__container,.pswp__zoom-wrap{touch-action:none;position:absolute;left:0;right:0;top:0;bottom:0;-webkit-backface-visibility:hidden}.pswp__container,.pswp__img{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;-webkit-tap-highlight-color:transparent;-webkit-touch-callout:none}.pswp__zoom-wrap{position:absolute;width:100%;-webkit-transform-origin:left top;transform-origin:left top;-webkit-transition:-webkit-transform 333ms cubic-bezier(.4,0,.22,1);transition:transform 333ms cubic-bezier(.4,0,.22,1),-webkit-transform 333ms cubic-bezier(.4,0,.22,1)}.pswp__bg{will-change:opacity;-webkit-transition:opacity 333ms cubic-bezier(.4,0,.22,1);transition:opacity 333ms cubic-bezier(.4,0,.22,1)}.pswp--animated-in .pswp__bg,.pswp--animated-in .pswp__zoom-wrap{-webkit-transition:none;transition:none}.pswp__item{position:absolute;left:0;right:0;top:0;bottom:0;overflow:hidden}.pswp__img{position:absolute;width:auto;height:auto;top:0;left:0}.pswp__img--placeholder{-webkit-backface-visibility:hidden}.pswp__img--placeholder--blank{background:#222}.pswp--ie .pswp__img{width:100%!important;height:auto!important;left:0;top:0}.pswp__error-msg{position:absolute;left:0;top:50%;width:100%;text-align:center;font-size:14px;line-height:16px;margin-top:-8px;color:#ccc}.pswp__error-msg a{color:#ccc;text-decoration:underline}.pswp__button{position:relative;cursor:pointer;overflow:visible;-webkit-appearance:none;display:block;border:0;padding:0;margin:0;float:right;opacity:.75;-webkit-transition:opacity .2s;transition:opacity .2s;box-shadow:none}.pswp__button:focus,.pswp__button:hover{opacity:1}.pswp__button:active{outline:0;opacity:.9}.pswp__button::-moz-focus-inner{padding:0;border:0}.pswp__ui--over-close .pswp__button--close{opacity:1}.pswp__button,.pswp__button--arrow--left:before,.pswp__button--arrow--right:before{background:url(data:image/png;base64,) 0 0/264px 88px no-repeat;width:44px;height:44px}@media (-webkit-min-device-pixel-ratio:1.1),(-webkit-min-device-pixel-ratio:1.09375),(min-resolution:105dpi),(min-resolution:1.1dppx){.pswp--svg .pswp__button,.pswp--svg .pswp__button--arrow--left:before,.pswp--svg .pswp__button--arrow--right:before{background-image:url(\"data:image/svg+xml,%3Csvg width='264' height='88' viewBox='0 0 264 88' xmlns='http://www.w3.org/2000/svg'%3E%3Ctitle%3Edefault-skin 2%3C/title%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg%3E%3Cpath d='M67.002 59.5v3.768c-6.307.84-9.184 5.75-10.002 9.732 2.22-2.83 5.564-5.098 10.002-5.098V71.5L73 65.585 67.002 59.5z' id='Shape' fill='%23fff'/%3E%3Cg fill='%23fff'%3E%3Cpath d='M13 29v-5h2v3h3v2h-5zM13 15h5v2h-3v3h-2v-5zM31 15v5h-2v-3h-3v-2h5zM31 29h-5v-2h3v-3h2v5z' id='Shape'/%3E%3C/g%3E%3Cg fill='%23fff'%3E%3Cpath d='M62 24v5h-2v-3h-3v-2h5zM62 20h-5v-2h3v-3h2v5zM70 20v-5h2v3h3v2h-5zM70 24h5v2h-3v3h-2v-5z'/%3E%3C/g%3E%3Cpath d='M20.586 66l-5.656-5.656 1.414-1.414L22 64.586l5.656-5.656 1.414 1.414L23.414 66l5.656 5.656-1.414 1.414L22 67.414l-5.656 5.656-1.414-1.414L20.586 66z' fill='%23fff'/%3E%3Cpath d='M111.785 65.03L110 63.5l3-3.5h-10v-2h10l-3-3.5 1.785-1.468L117 59l-5.215 6.03z' fill='%23fff'/%3E%3Cpath d='M152.215 65.03L154 63.5l-3-3.5h10v-2h-10l3-3.5-1.785-1.468L147 59l5.215 6.03z' fill='%23fff'/%3E%3Cg%3E%3Cpath id='Rectangle-11' fill='%23fff' d='M160.957 28.543l-3.25-3.25-1.413 1.414 3.25 3.25z'/%3E%3Cpath d='M152.5 27c3.038 0 5.5-2.462 5.5-5.5s-2.462-5.5-5.5-5.5-5.5 2.462-5.5 5.5 2.462 5.5 5.5 5.5z' id='Oval-1' stroke='%23fff' stroke-width='1.5'/%3E%3Cpath fill='%23fff' d='M150 21h5v1h-5z'/%3E%3C/g%3E%3Cg%3E%3Cpath d='M116.957 28.543l-1.414 1.414-3.25-3.25 1.414-1.414 3.25 3.25z' fill='%23fff'/%3E%3Cpath d='M108.5 27c3.038 0 5.5-2.462 5.5-5.5s-2.462-5.5-5.5-5.5-5.5 2.462-5.5 5.5 2.462 5.5 5.5 5.5z' stroke='%23fff' stroke-width='1.5'/%3E%3Cpath fill='%23fff' d='M106 21h5v1h-5z'/%3E%3Cpath fill='%23fff' d='M109.043 19.008l-.085 5-1-.017.085-5z'/%3E%3C/g%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")}.pswp--svg .pswp__button--arrow--left,.pswp--svg .pswp__button--arrow--right{background:0 0}}.pswp__button--close{background-position:0 -44px}.pswp__button--share{background-position:-44px -44px}.pswp__button--fs{display:none}.pswp--supports-fs .pswp__button--fs{display:block}.pswp--fs .pswp__button--fs{background-position:-44px 0}.pswp__button--zoom{display:none;background-position:-88px 0}.pswp--zoom-allowed .pswp__button--zoom{display:block}.pswp--zoomed-in .pswp__button--zoom{background-position:-132px 0}.pswp--touch .pswp__button--arrow--left,.pswp--touch .pswp__button--arrow--right{visibility:hidden}.pswp__button--arrow--left,.pswp__button--arrow--right{background:0 0;top:50%;margin-top:-50px;width:70px;height:100px;position:absolute}.pswp__button--arrow--left{left:0}.pswp__button--arrow--right{right:0}.pswp__button--arrow--left:before,.pswp__button--arrow--right:before{content:\"\";top:35px;background-color:rgba(0,0,0,.3);height:30px;width:32px;position:absolute}.pswp__button--arrow--left:before{left:6px;background-position:-138px -44px}.pswp__button--arrow--right:before{right:6px;background-position:-94px -44px}.pswp__counter,.pswp__share-modal{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.pswp__share-modal{display:block;background:rgba(0,0,0,.5);width:100%;height:100%;top:0;left:0;padding:10px;position:absolute;z-index:1600;opacity:0;-webkit-transition:opacity .25s ease-out;transition:opacity .25s ease-out;-webkit-backface-visibility:hidden;will-change:opacity}.pswp__share-modal--hidden{display:none}.pswp__share-tooltip{z-index:1620;position:absolute;background:#fff;top:56px;border-radius:2px;display:block;width:auto;right:44px;box-shadow:0 2px 5px rgba(0,0,0,.25);-webkit-transform:translateY(6px);transform:translateY(6px);-webkit-transition:-webkit-transform .25s;transition:transform .25s;transition:transform .25s,-webkit-transform .25s;-webkit-backface-visibility:hidden;will-change:transform}.pswp__share-tooltip a{display:block;padding:8px 12px;color:#000;text-decoration:none;font-size:14px;line-height:18px}.pswp__share-tooltip a:hover{text-decoration:none;color:#000}.pswp__share-tooltip a:first-child{border-radius:2px 2px 0 0}.pswp__share-tooltip a:last-child{border-radius:0 0 2px 2px}.pswp__share-modal--fade-in{opacity:1}.pswp__share-modal--fade-in .pswp__share-tooltip{-webkit-transform:translateY(0);transform:translateY(0)}.pswp--touch .pswp__share-tooltip a{padding:16px 12px}a.pswp__share--facebook:before{content:\"\";display:block;width:0;height:0;position:absolute;top:-12px;right:15px;border:6px solid transparent;border-bottom-color:#fff;-webkit-pointer-events:none;-moz-pointer-events:none;pointer-events:none}a.pswp__share--facebook:hover{background:#3e5c9a;color:#fff}a.pswp__share--facebook:hover:before{border-bottom-color:#3e5c9a}a.pswp__share--twitter:hover{background:#55acee;color:#fff}a.pswp__share--pinterest:hover{background:#ccc;color:#ce272d}a.pswp__share--download:hover{background:#ddd}.pswp__counter{position:absolute;left:0;top:0;height:44px;font-size:13px;line-height:44px;color:#fff;opacity:.75;padding:0 10px}.pswp__caption{position:absolute;left:0;bottom:0;width:100%;min-height:44px}.pswp__caption small{font-size:11px;color:#bbb}.pswp__caption__center{text-align:left;max-width:420px;margin:0 auto;font-size:13px;padding:10px;line-height:20px;color:#ccc}.pswp__caption--empty{display:none}.pswp__caption--fake{visibility:hidden}.pswp__preloader{width:44px;height:44px;position:absolute;top:0;left:50%;margin-left:-22px;opacity:0;-webkit-transition:opacity .25s ease-out;transition:opacity .25s ease-out;will-change:opacity;direction:ltr}.pswp__preloader__icn{width:20px;height:20px;margin:12px}.pswp__preloader--active{opacity:1}.pswp__preloader--active .pswp__preloader__icn{background:url(data:image/gif;base64,) no-repeat}.pswp--css_animation .pswp__preloader--active{opacity:1}.pswp--css_animation .pswp__preloader--active .pswp__preloader__icn{-webkit-animation:.5s linear infinite clockwise;animation:.5s linear infinite clockwise}.pswp--css_animation .pswp__preloader--active .pswp__preloader__donut{-webkit-animation:1s cubic-bezier(.4,0,.22,1) infinite donut-rotate;animation:1s cubic-bezier(.4,0,.22,1) infinite donut-rotate}.pswp--css_animation .pswp__preloader__icn{background:0 0;opacity:.75;width:14px;height:14px;position:absolute;left:15px;top:15px;margin:0}.pswp--css_animation .pswp__preloader__cut{position:relative;width:7px;height:14px;overflow:hidden}.pswp--css_animation .pswp__preloader__donut{box-sizing:border-box;width:14px;height:14px;border:2px solid #fff;border-radius:50%;border-left-color:transparent;border-bottom-color:transparent;position:absolute;top:0;left:0;background:0 0;margin:0}@media screen and (max-width:1024px){.pswp__preloader{position:relative;left:auto;top:auto;margin:0;float:right}}@-webkit-keyframes clockwise{0%{-webkit-transform:rotate(0);transform:rotate(0)}100%{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@keyframes clockwise{0%{-webkit-transform:rotate(0);transform:rotate(0)}100%{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@-webkit-keyframes donut-rotate{0%,100%{-webkit-transform:rotate(0);transform:rotate(0)}50%{-webkit-transform:rotate(-140deg);transform:rotate(-140deg)}}@keyframes donut-rotate{0%,100%{-webkit-transform:rotate(0);transform:rotate(0)}50%{-webkit-transform:rotate(-140deg);transform:rotate(-140deg)}}.pswp__ui{-webkit-font-smoothing:auto;visibility:visible;opacity:1;z-index:1550}.pswp__top-bar{position:absolute;left:0;top:0;height:44px;width:100%}.pswp--has_mouse .pswp__button--arrow--left,.pswp--has_mouse .pswp__button--arrow--right,.pswp__caption,.pswp__top-bar{-webkit-backface-visibility:hidden;will-change:opacity;-webkit-transition:opacity 333ms cubic-bezier(.4,0,.22,1);transition:opacity 333ms cubic-bezier(.4,0,.22,1)}.pswp--has_mouse .pswp__button--arrow--left,.pswp--has_mouse .pswp__button--arrow--right{visibility:visible}.pswp__caption,.pswp__top-bar{background-color:rgba(0,0,0,.5)}.pswp__ui--fit .pswp__caption,.pswp__ui--fit .pswp__top-bar{background-color:rgba(0,0,0,.3)}.pswp__ui--idle .pswp__button--arrow--left,.pswp__ui--idle .pswp__button--arrow--right,.pswp__ui--idle .pswp__top-bar{opacity:0}.pswp__ui--hidden .pswp__button--arrow--left,.pswp__ui--hidden .pswp__button--arrow--right,.pswp__ui--hidden .pswp__caption,.pswp__ui--hidden .pswp__top-bar{opacity:.001}.pswp__ui--one-slide .pswp__button--arrow--left,.pswp__ui--one-slide .pswp__button--arrow--right,.pswp__ui--one-slide .pswp__counter{display:none}.pswp__element--disabled{display:none!important}.pswp--minimal--dark .pswp__top-bar{background:0 0}"];
var RenderType_NgxImageboxComponent = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵcrt"]({ encapsulation: 2, styles: styles_NgxImageboxComponent, data: {} });

function View_NgxImageboxComponent_1(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](0, 0, null, null, 4, "figure", [["itemprop", "associatedMedia"], ["itemscope", ""], ["itemtype", "http://schema.org/ImageObject"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵeld"](1, 0, null, null, 1, "a", [["itemprop", "contentUrl"]], [[8, "href", 4], [1, "data-size", 0]], [[null, "click"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("click" === en)) {
...
/* harmony import */ var _dist_ngx_image_box_ngx_image_box_ngfactory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../dist/ngx-image-box/ngx-image-box.ngfactory */ "../../dist/ngx-image-box/ngx-image-box.ngfactory.js");
/* harmony import */ var ngx_image_box__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-image-box */ "../../dist/ngx-image-box/fesm5/ngx-image-box.js");
 ...
 * tslint:disable
 */ 
var styles = [".demo[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  color: #00acf4;\n}\n.demo[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  max-width: 220px;\n  cursor: pointer;\n}\n/*# sourceMappingURL=data:application/json;base64, */"];
...
/* harmony import */ var ngx_image_box__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ngx-image-box */ "../../dist/ngx-image-box/fesm5/ngx-image-box.js");

var AppComponent = /** @class */ (function () {
    function AppComponent(_ls) {
        this._ls = _ls;
    ...
    AppComponent.prototype.open = function (imageIndex) {
        if (imageIndex === void 0) { imageIndex = 0; }
        this._ls.createGallery('galleryKey');
        var self = this;
        this.images.forEach(function (value) {
            var img = new ngx_image_box__WEBPACK_IMPORTED_MODULE_0__["Image"]();
    ...
    AppComponent.prototype.autoSlide = function (index) {
        this._ls.createGallery('galleryKey');
        var self = this;
        this.images.forEach(function (value) {
            var img = new ngx_image_box__WEBPACK_IMPORTED_MODULE_0__["Image"]();
...
/* harmony import */ var ngx_image_box__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-image-box */ "../../dist/ngx-image-box/fesm5/ngx-image-box.js");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
...
module.exports = __webpack_require__(/*! /Users/akashs/ng-image-box/NgxImageBox/projects/NgxImageBoxDemo/src/main.ts */"./src/main.ts");
